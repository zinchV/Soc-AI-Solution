...
- NEVER use backslash characters (\\) anywhere in the KQL - they cause syntax errors
- NEVER use escape sequences like \\n, \\t, \\r, or \\" in the KQL output
- Use single quotes for strings when possible, or unescaped double quotes
- Do NOT use line continuation characters
