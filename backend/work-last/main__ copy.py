...
# Include ingestion router for real-time SIEM ingestion
app.include_router(ingestion_router)

# Include SIEM simulator router for testing
...
async def startup():
    ...
    print(f"   - POST /api/v1/ingest/alert (generic)")
    print(f"   - POST /api/v1/ingest/alerts (batch)")
    print(f"   - POST /api/v1/ingest/splunk")
    print(f"   - POST /api/v1/ingest/qradar")
    print(f"   - POST /api/v1/ingest/elastic")
    print(f"   - POST /api/v1/ingest/sentinel")
    print(f"   - POST /api/v1/ingest/cef")
    print(f"✅ SIEM Simulator available:")
    print(f"   - GET  /api/v1/simulator/status")
    print(f"   - POST /api/v1/simulator/generate/scenario")
    print(f"   - POST /api/v1/simulator/generate/demo")
    print(f"   - POST /api/v1/simulator/start (continuous)")
    print("=" * 60)
